...
def new_customer():
    ...
    abc = "INSERT INTO new_customer (Customer_Name, Phone_no, Email) VALUES ('{}', '{}', '{}')".format(Customer_Name,
                                                                                                       Phone_no, Email)
    c1.execute(abc)
    con.commit()
    print("")
...
def Customer_Bill():
    ...
    yz = "INSERT INTO Bill (Customer_Name, Accessed_Time, Total_Bill) VALUES ('{}', '{}', '{}')".format(Customer_Name,
                                                                                                        Accessed_Time,
                                                                                                        Total_Bill)
    c1.execute(yz)
    con.commit()
...
def bill_stuff():
    ...
    if Na == 1:
        ...
        if ez == 1:
            ...
            print("NAME ||   TIME ACCESSED || TOTAL AMOUNT TO BE PAID")
            f = open("bill.csv", "r")
            for line in f:
                if Name in line:
                    print(line)
...
while True:
    ...
    if Choice == 1:
        ...
        if ("new_customer",) in data:
            ...
            c1 = con.cursor()
            c1.execute(
                "create table New_Customer(ID int PRIMARY KEY NOT NULL AUTO_INCREMENT, Customer_Name varchar(25), Phone_no int(10) ,Email varchar(25))")
            con.commit()
            print("Table created")
            new_customer()
